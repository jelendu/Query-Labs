...
const revertchangeButtonColor = () => {
  sayHelloButton.style.backgroundColor = "#EFEFEF";
  sayHelloButton.style.color = "black";
};
sayHelloButton.addEventListener("mouseout", revertchangeButtonColor);
...
document
  ...
  .addEventListener("click", repeatMyParam("free tacos"));
...
const sendQuery = () => {
  axios
    .get("http://localhost:3000/query-test?tacos=query&test=another")
    .then((res) => {
      console.log(res.data);
    });
};
...
//1. axios.get('http://localhost:3000/query-test') -> You sent an empty query!
//2. axios.get('http://localhost:3000/query-test?tacos=query&test=another') -> You sent more than 1 query!
